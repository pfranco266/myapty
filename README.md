Myapty: my mapty (I'm corny, I know). Mapty is an application let's users track, view and record their workouts on a map. Users are able to add two different types of workouts: running, cycling.
